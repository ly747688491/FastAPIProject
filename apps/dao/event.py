...
from apps.models.event_log import EventLog
from apps.utils.system_utils.custom_json import CustomJSONEncoder
from apps.utils.system_utils.db import DbUtils
from apps.utils.system_utils.obj2dict import obj2dict
...
class EventDao(object):
    ...
    def get_event_log(self, event_id: int, relation_obj: str, before_data=None) -> EventLog:
        ...
        if before_data:
            ...
            event_log.before_data = obj2dict(before_data)
    ...
    def create_event_log(self, event_log: EventLog, after_data=None):
        ...
        """
        if after_data:
            event_log.after_data = obj2dict(after_data)
